const ProductItem = ({ url, title }: { url: string; title: string }) => {
  return (
    <div className="border shadow-md py-4 rounded-xl hover:shadow-xl transition-all cursor-pointer">
...
export default function Explore() {
  return (
    <div className="w-full">
      ...
      <div className="mt-8 flex gap-4 justify-evenly font-light mulish-regular">
        <ProductItem
