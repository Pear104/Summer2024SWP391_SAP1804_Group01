...
export default function TopNav() {
  ...
  return (
    <div className="top-0 left-0 relative gap-4 py-3 px-4 bg-white w-full shadow-2xl">
      ...
      <div className="flex gap-4 mt-2">
        ...
        >
          ...
          {jewelryDrop && (
            <div className="z-50 w-[100vw] fixed mx-auto top-[96px] left-0 right-0 bg-white">
